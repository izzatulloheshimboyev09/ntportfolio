export const INITIAL_DATA = {
  profile: {
    ...
    email: "izzatulloheshimboyev09@gmail.com",
    github: "https://github.com",
    telegram: "https://t.me/izzatulloh_devm",
  ...
  skills: [
    ...
    {
      id: "10",
      name: "Responsive & Glassmorphism UI",
      level: 98,
      category: "UI/UX",
      icon: "Layout",
    },
  ...
  projects: [
    {
      ...
      category: "Fintech",
      description:
        "Haqiqiy vaqt rejimida kriptovalyutalar dinamikasi, shamchalar grafiklari va savdo tahlilini taqdim etuvchi ultra-tezkor tahliliy dashboard.",
      image:
    ...
    },
    {
      ...
      category: "E-Commerce",
      description:
        "Dark-cyberpunk uslubidagi premium elektron tijorat platformasi. Savatcha, to'lov tizimlari va tezkor qidiruv integratsiyalangan.",
      image:
    ...
    },
    {
      ...
      description:
        "Dasturchilar va IT jamoalar uchun vazifalarni boshqarish tizimi. Drag-and-drop, sprint tahlili va jamoaviy chat funksiyalari.",
      image:
    ...
    },
    {
      ...
      category: "AI Tools",
      description:
        "Sun'iy intellekt modellarini sinash, promptlar to'plami va kod generatsiyasi uchun mo'ljallangan qulay developer interfeysi.",
      image:
    ...
    },
    {
      ...
      category: "Media",
      description:
        "Minimalistik musiqa va podcast platformasi. Audio vizualizatsiyasi, pleylistlar va offline kesh xotirasi bilan jihozlangan.",
      image:
  ...
  messages: [
    {
      ...
      message:
        "Salom Izzatulloh! Sizning portfoliongizdagi Nexus Crypto loyihangiz juda yoqdi. Bizning yangi platformamizga Front-end arxitektor kerak, qachon suhbatlashsak bo'ladi?",
    ...
    },
    {
      ...
      message:
        "Assalomu alaykum! Bizda zamonaviy SaaS CRM tizimi bor. React va Tailwind bilan UI ni qayta ishlab chiqish kerak.",
